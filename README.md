...
Тут есть небольшая система плагинов, а так же простой регистратор ивентов.
(Всё это чудо спизженно с чужого проекта... Опенсус, хули)

Список кодов ошибок, приводящих к крашу сервера находится в msnt.exitcodes.txt
	Задокументированно не всё, но та часть, которую я пытался задокументировать
```
